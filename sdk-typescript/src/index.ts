...
/* tslint:disable */
/* eslint-disable */
export { IndexifyClient } from './IndexifyClient';
...
export type { SyncNamespace } from './models/SyncNamespace';
export type { SyncNamespaceResponse } from './models/SyncNamespaceResponse';
