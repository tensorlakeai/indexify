...
//     },
//     {
//       field: 'computeGraphName',
//       headerName: 'Extraction Graph Name',
//       flex: 2,
//       valueGetter: (params) => params.row.name,
//       renderCell: (params) => {
//         const computeGraphName = params.value.split('.')[0] || '';
//         return (
//           <>
//             <Link
//               to={`/${namespace}/extraction-graphs/${computeGraphName}`}
//             >
//               {computeGraphName}
//             </Link>
//             <CopyText text={computeGraphName} className="show-onHover" />
//           </>
//         )
//       },
//     },
