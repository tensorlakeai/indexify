...
from indexify.proto.executor_api_pb2 import TaskResult
from indexify.proto.executor_api_pb2_grpc import ExecutorAPIStub

from .blob_store.blob_store import BLOBStore
from .function_executor.task_output import TaskOutput
from .grpc.channel_manager import ChannelManager
from .grpc.task_output_uploader import (
...
class ExecutorIO:
    ...
    async def upload_task_outputs(self, output: TaskOutput, logger: Any) -> TaskResult:
        """Uploads the task outputs to the server."""
