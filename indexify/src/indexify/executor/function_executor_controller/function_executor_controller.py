...
from .function_executor_creation_output import FunctionExecutorCreationOutput
...
class FunctionExecutorController:
    def __init__(
        ...
        self._function_executor_creation_output: Optional[
            FunctionExecutorCreationOutput
        ] = None
        self._function_executor_termination_reason: (
            FunctionExecutorTerminationReason
        ) = None  # Optional
    ...
    def startup(self) -> None:
        ...
        self._spawn_aio_for_fe(
            ...
            on_exception=FunctionExecutorCreated(
                ...
                output=FunctionExecutorCreationOutput(
                    function_executor_description=self._function_executor_description,
    ...
    def _handle_event_function_executor_created(
        ...
        Doesn't raise any exceptions. Doesn't block.
        """
        self._function_executor_creation_output = event.output
    ...
    def _handle_event_function_executor_destroyed(
        ...
        self._function_executor_termination_reason = event.termination_reason
