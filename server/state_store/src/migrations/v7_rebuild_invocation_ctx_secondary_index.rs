...
#[derive(Clone)]
pub struct V7RebuildSecondaryIndexesMigration {}

impl Migration for V7RebuildSecondaryIndexesMigration {
    fn version(&self) -> u64 {
        7
    }
...
mod tests {
    ...
    use super::*;
    use crate::migrations::testing::MigrationTestBuilder;

    #[test]
    fn test_v7_migration() -> Result<()> {
        let migration = V7RebuildSecondaryIndexesMigration {};
