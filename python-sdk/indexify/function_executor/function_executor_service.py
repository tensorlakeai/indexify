...
class FunctionExecutorService(FunctionExecutorServicer):
    def __init__(self):
        ...
        self._invocation_state_proxy_server = Optional[InvocationStateProxyServer] = (
            None
        )
    ...
    def initialize_invocation_state_server(
        self,
        client_response_iterator: Iterator[InvocationStateResponse],
        context: grpc.ServicerContext,
    ):
        self._invocation_state_proxy_server = InvocationStateProxyServer(
            client_response_iterator, self._logger
        )
