...
class RunTaskRequest(_message.Message):
    ...
    GRAPH_INVOCATION_PAYLOAD_FIELD_NUMBER: _ClassVar[int]
    ...
    graph_invocation_payload: SerializedObject
    ...
    def __init__(
        ...
        graph_invocation_payload: _Optional[_Union[SerializedObject, _Mapping]] = ...,
