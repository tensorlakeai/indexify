...
use crate::persistence::{DataRepository, Extractor, ExtractorType, IndexDistance, Text};
...
async fn get_index_creation_args(
    ...
    let index_params = CreateIndexParams {
        ...
        metric: match payload.metric {
            ApiIndexDistance::Cosine => MetricKind::Cosine,
            ApiIndexDistance::Dot => MetricKind::Dot,
            ApiIndexDistance::Euclidean => MetricKind::Euclidean,
        },
