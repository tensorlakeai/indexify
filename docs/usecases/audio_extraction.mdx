...
We offer a range of audio extractors to suit your specific needs. Here's a quick overview of our pre-built extractors:

| Extractor                | Output Type | Best For                                                                             | Example Usage                                                                                                                                  |
|--------------------------|-------------|--------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------|
| tensorlake/whisper-mlx   | text        | macOS devices                                                                        |   |
| tensorlake/whisper-asr   | text        | Regular devices                                                                      | [Audio RAG](https://github.com/tensorlakeai/indexify/tree/main/examples/audio/chunking_and_indexing), [Audio Transcription](https://github.com/tensorlakeai/indexify/tree/main/examples/audio/transcription)                                                            |
