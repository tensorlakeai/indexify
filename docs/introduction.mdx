...
<CodeGroup>
    ...
    import { IndexifyClient, ExtractionGraph } from './indexify';
...
<CodeGroup>
    ...
    ```
    ```typescript
    import { IndexifyClient } from './indexify';
    import * as fs from 'fs';
...
<CodeGroup>
    ...
    ```
    ```typescript TypeScript
    import { IndexifyClient, IContentMetadata } from './indexify';
...
<CodeGroup>
    ...
    ```
    ```typescript
    import { IndexifyClient, ISearchIndexResponse } from './indexify';
