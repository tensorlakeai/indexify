...
```bash filename="( Terminal 1 ) Description Of Command"
<command goes here>
```
...
```bash copy filename="( Terminal 2 ) Install Dependencies"
python3 -m venv venv
...
```py filename="( Terminal 2 ) Starting Extractor Workers"
