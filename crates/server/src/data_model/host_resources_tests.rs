...
mod tests {
    ...
    fn test_consume_function_resources() {
        struct Case {
            ...
            host_resources: HostResources,
            func_resources: FunctionResources,
            expected_fe_resources: Option<FunctionContainerResources>, // None means error expected
        ...
        let cases = vec![
            Case {
                ...
                expected_fe_resources: Some(FunctionContainerResources {
                    cpu_ms_per_sec: 1000,
                    memory_mb: 1024,
                    ephemeral_disk_mb: 1024,
                    gpu: None,
    ...
    fn test_free_fe_resources() {
        struct Case {
            description: &'static str,
            host_resources: HostResources,
            fe_resources: FunctionContainerResources,
            expect_success: bool,
